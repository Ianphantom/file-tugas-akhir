...
const DokterRegister = () => {
  ...
  const closeHandler = () => {
    ...
    setTimeout(() => {
      navigate(
        "/doctor/login?messege=Account Has Been Registered! Read Email from Us for your private key information and email validation"
      );
    }, 2000);
  };
    ...
    <InformationContainer>
      ...
      <RegisterContainer className='container'>
        <div className='left' data-aos='zoom-in' data-aos-duration='2000'>
          <div className='title'>Welcome to Doctor Page</div>
