...
class LevelTwo implements FilterInterface
{
    /**
    ...
    public function before(RequestInterface $request, $arguments = null)
    {
        ...
        if($decoded->permission_level < 2) return Services::response()->setJSON(['message' => "You are not authorized to use this method"])->setStatusCode(ResponseInterface::HTTP_UNAUTHORIZED);
